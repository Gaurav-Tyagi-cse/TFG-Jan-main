...
s1.async=true;
s1.src='https://embed.tawk.to/6718d1f34304e3196ad67d37/1iasf88d5';
s1.charset='UTF-8';
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  openChatBtn.addEventListener("click", function () {
      if (Tawk_API && typeof Tawk_API.toggle === "function") {
          Tawk_API.toggle(); // Opens the chat widget
      } else {
          console.log("Tawk.to API not ready yet");
      }
  });
});
